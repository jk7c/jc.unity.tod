...
namespace TimeOfDay
{
    ...
    [Serializable] public struct TOD_LightParams
    {
        public float intensity;
        public Gradient color;
    }

    [Serializable] public class TOD_AmbientParams
    {
    ...
    public partial class TOD_Dome : MonoBehaviour
    {
        ...
        [SerializeField] TOD_LightParams m_SunParams = new TOD_LightParams
        {
            intensity = 1.0f,
            color     = new Gradient()
        };

        [SerializeField] TOD_LightParams m_MoonParams = new TOD_LightParams
        {
            intensity = 0.3f,
            color     = new Gradient()
        };
        ...
        // Ambient- 
        ////////////////////
        [SerializeField] TOD_AmbientParams m_AmbientParams = new TOD_AmbientParams
        {
            sendSkybox       = false,
