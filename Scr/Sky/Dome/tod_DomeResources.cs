...
namespace TimeOfDay
{
    ...
    public partial class TOD_Dome : MonoBehaviour
    {
        ...
        [SerializeField] private TOD_Resources m_Resources = null;

        /// <summary></summary>
        public TOD_Resources Resources => m_Resources;
        ...
        /// <summary></summary>
        /// <param="quality"></param>
        private Mesh GetSphereMesh(TOD_Quality4 quality)
        {
            switch(quality)
            {
                case TOD_Quality4.Low: 
                    return m_Resources.sphereLOD3;

                case TOD_Quality4.Medium:
                    return m_Resources.sphereLOD2; 

                case TOD_Quality4.High: 
                    return m_Resources.sphereLOD1;

                case TOD_Quality4.Ultra: 
        ...
        /// <summary></summary>
        /// <param="quality"></param>
        private Mesh GetHemisphereMesh(TOD_Quality4 quality)
        {
            switch(quality)
            {
                case TOD_Quality4.Low:
        ...
        /// <summary></summary>
        /// <param="quality"></param>
        private Mesh GetAtmosphereMesh(TOD_Quality4 quality)
        {
            switch(quality)
            {
                case TOD_Quality4.Low: 
