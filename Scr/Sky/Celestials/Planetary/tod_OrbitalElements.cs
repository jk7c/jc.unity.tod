...
namespace TimeOfDay
{
    public struct TOD_OrbitalElements
    {
        /// <summary>
        ...
        /// <summary></summary>
        public TOD_OrbitalElements(float _N, float _i, float _w, float _a, float _e, float _M)
        {
            this.N = _N;
            this.i = _i;
            this.w = _w;
        ...
        static readonly TOD_OrbitalElements m_Zero = new TOD_OrbitalElements
        {
            N = 0.0f, 
            i = 0.0f, 
            w = 0.0f, 
        ...
        /// <summary></summary>
        public static TOD_OrbitalElements Zero{ get{ return m_Zero; } }

        public static TOD_OrbitalElements SetOrbitalElements(int index, float timeScale)
        {
            TOD_OrbitalElements re = m_Zero;
