...
namespace TimeOfDay.Utility
{
    ...
    [CustomEditor(typeof(TOD_DateTimeManager))]
    public class TOD_DateTimeManagerEditor : TOD_CommonEditor
    {

        // Target
        ////////////////
        TOD_DateTimeManager tar;
        ...
        protected override void OnEnable()
        {
            ...
            base.OnEnable();
            tar = (TOD_DateTimeManager)target;
    ...
    #region |OnInspectorGUI|
        ...
        #region Time.
            ...
            TOD_EditorGUIUtility.ShurikenFoldoutHeader("Time", ref m_TimeFoldout, TOD_ShurikenStyle.Tab);
            if(m_TimeFoldout)
            {
                TOD_EditorGUIUtility.ShurikenHeader("Timeline", TextTabTitleStyle, TOD_ShurikenStyle.Title);
                    ...
                    EditorGUILayout.PropertyField(m_TotalHours, new GUIContent("Total Hours"));
                    EditorGUILayout.EndVertical();

                    GUI.backgroundColor = Color.white;
                EditorGUILayout.Separator();

                TOD_EditorGUIUtility.ShurikenHeader("Time Length", TextTabTitleStyle, TOD_ShurikenStyle.Title);
                EditorGUILayout.Separator();
            ...
            if(!m_SyncWithSystem.boolValue)
            {
                ...
                if(m_EnableDayNightLength.boolValue)
                {
                    ...
                    TOD_EditorGUIUtility.ShurikenHeader("Day Range", TextTabTitleStyle, TOD_ShurikenStyle.Title);
                    ...
                    TOD_EditorGUIUtility.Separator(2);
        ...
        #region Date
            ...
            TOD_EditorGUIUtility.ShurikenFoldoutHeader("Date", ref m_DateFoldout, TOD_ShurikenStyle.Tab);
            if(m_DateFoldout)
            {
        ...
        #region System.
            ...
            TOD_EditorGUIUtility.ShurikenFoldoutHeader("System", ref m_OptionsFoldout, TOD_ShurikenStyle.Tab);
            if(m_OptionsFoldout)
            {
                EditorGUILayout.Separator();
        ...
        #region |Events|
            ...
            {
                TOD_EditorGUIUtility.ShurikenFoldoutHeader("Time Events", ref m_TimeEventsFoldout, TOD_ShurikenStyle.Tab);
                ...
                TOD_EditorGUIUtility.ShurikenFoldoutHeader("Date Events",  ref m_DateEventsFoldout, TOD_ShurikenStyle.Tab);
