...
{
    [ExecuteInEditMode]
    [AddComponentMenu("TimeOfDay/Utility/DateTime/DateTime Manager")]
    public class TOD_DateTimeManager : MonoBehaviour
    {
    #region [Fields]
    ...
    #region [Events]
        ...
        [SerializeField] protected TOD_EventType m_CheckEventsType = TOD_EventType.Unity;
    ...
    #region [Helpers]
        ...
        {
            m_TotalHours = TOD_DateTimeUtility.GetTotalHours(hour);
        }
        ...
        {
            m_TotalHours = TOD_DateTimeUtility.GetTotalHours(hour, minute);
        }
        ...
        {
            m_TotalHours = TOD_DateTimeUtility.GetTotalHours(hour, minute, second);
        }
        ...
        {
            m_TotalHours = TOD_DateTimeUtility.GetTotalHours(hour, minute, second, millisecond);
        }
    ...
    #region [Events]
        ...
        void CheckEvents()
        {
            ...
            {
                case TOD_EventType.Unity:     CheckUnityEvents();    break;
                case TOD_EventType.Delegates: CheckDelegateEvents(); break;
                case TOD_EventType.Both:
                    CheckUnityEvents();
                    CheckDelegateEvents();
                break;
            }
