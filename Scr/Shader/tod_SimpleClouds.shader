Shader "TOD Sky/Simple Clouds"
{
    ...
    #include "tod_CloudsInclude.hlsl"
    ...
    uniform half4 TOD_CloudsTint;
    uniform half  TOD_CloudsIntensity;
    ...
    v2f vert(appdata_base v)
    {
        ...
        o.texcoord = TRANSFORM_TEX(v.texcoord, TOD_CloudsTex);

        o.texcoord1.xy = o.texcoord;
        o.texcoord1.y *= TOD_CloudsTint.a;
        //----------------------------------------------------------------------------
             
        o.col.rgb = TOD_CloudsTint.rgb * TOD_CloudsIntensity * TOD_GlobalIntensity;
